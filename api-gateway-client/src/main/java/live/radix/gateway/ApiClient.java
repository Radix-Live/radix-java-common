...
import live.radix.gateway.auth.Authentication;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  private String basePath = "http://localhost:5208";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    ...
    new ServerConfiguration(
      "https://stokenet-gateway.radixdlt.com",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://mainnet-gateway.radixdlt.com",
      "No description provided",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(CloseableHttpClient httpClient) {
    ...
    setUserAgent("OpenAPI-Generator/1.1.2-L/java");
