...
import live.radix.gateway.model.ValidatorAccountStake;
 ...
 */
@JsonPropertyOrder({
  ValidatorStakesResponse.JSON_PROPERTY_LEDGER_STATE,
  ValidatorStakesResponse.JSON_PROPERTY_TOTAL_COUNT,
  ValidatorStakesResponse.JSON_PROPERTY_NEXT_CURSOR,
  ValidatorStakesResponse.JSON_PROPERTY_ACCOUNT_STAKE_DELEGATIONS
})
@JsonTypeName("ValidatorStakesResponse")
...
public class ValidatorStakesResponse {
  ...
  public static final String JSON_PROPERTY_ACCOUNT_STAKE_DELEGATIONS = "account_stake_delegations";
  private List<ValidatorAccountStake> accountStakeDelegations = new ArrayList<>();

  public ValidatorStakesResponse() { 
  }

  public ValidatorStakesResponse ledgerState(LedgerState ledgerState) {
  ...
  **/
  ...
  public ValidatorStakesResponse totalCount(Long totalCount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The total number of accounts delegating stake to the validator in some state.")
  ...
  public ValidatorStakesResponse nextCursor(String nextCursor) {
  ...
  **/
  ...
  public ValidatorStakesResponse accountStakeDelegations(List<ValidatorAccountStake> accountStakeDelegations) {
    
    this.accountStakeDelegations = accountStakeDelegations;
    return this;
  }

  public ValidatorStakesResponse addAccountStakeDelegationsItem(ValidatorAccountStake accountStakeDelegationsItem) {
    this.accountStakeDelegations.add(accountStakeDelegationsItem);
    return this;
  }

   /**
   * The page of account stake delegations.
   * @return accountStakeDelegations
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The page of account stake delegations.")
  @JsonProperty(JSON_PROPERTY_ACCOUNT_STAKE_DELEGATIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<ValidatorAccountStake> getAccountStakeDelegations() {
    return accountStakeDelegations;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACCOUNT_STAKE_DELEGATIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAccountStakeDelegations(List<ValidatorAccountStake> accountStakeDelegations) {
    this.accountStakeDelegations = accountStakeDelegations;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidatorStakesResponse validatorStakesResponse = (ValidatorStakesResponse) o;
    return Objects.equals(this.ledgerState, validatorStakesResponse.ledgerState) &&
        Objects.equals(this.totalCount, validatorStakesResponse.totalCount) &&
        Objects.equals(this.nextCursor, validatorStakesResponse.nextCursor) &&
        Objects.equals(this.accountStakeDelegations, validatorStakesResponse.accountStakeDelegations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ledgerState, totalCount, nextCursor, accountStakeDelegations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidatorStakesResponse {\n");
    sb.append("    ledgerState: ").append(toIndentedString(ledgerState)).append("\n");
    sb.append("    totalCount: ").append(toIndentedString(totalCount)).append("\n");
    sb.append("    nextCursor: ").append(toIndentedString(nextCursor)).append("\n");
    sb.append("    accountStakeDelegations: ").append(toIndentedString(accountStakeDelegations)).append("\n");
    sb.append("}");
    return sb.toString();
  }
