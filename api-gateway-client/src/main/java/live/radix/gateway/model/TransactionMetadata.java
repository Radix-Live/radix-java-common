 ...
 */
@JsonPropertyOrder({
  TransactionMetadata.JSON_PROPERTY_HEX,
  TransactionMetadata.JSON_PROPERTY_MESSAGE
})
@JsonTypeName("TransactionMetadata")
...
public class TransactionMetadata {
  ...
  public TransactionMetadata hex(String hex) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The transaction payload, hex encoded.")
  ...
  **/
  ...
  @ApiModelProperty(value = "The message bytes, hex encoded.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hex, transactionMetadata.hex) &&
