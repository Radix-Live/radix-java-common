...
@JsonTypeName("AccountUnstakeEntry")
...
public class AccountUnstakeEntry {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The number of epochs until the XRD in this unstake will be released back to the account. This delay is to enable stake to be slashed, if the validator misbehaves. ")
