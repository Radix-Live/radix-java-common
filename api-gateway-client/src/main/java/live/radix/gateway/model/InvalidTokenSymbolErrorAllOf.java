 ...
 */
@JsonPropertyOrder({
  InvalidTokenSymbolErrorAllOf.JSON_PROPERTY_INVALID_TOKEN_SYMBOL
})
@JsonTypeName("InvalidTokenSymbolError_allOf")
...
public class InvalidTokenSymbolErrorAllOf {
  public static final String JSON_PROPERTY_INVALID_TOKEN_SYMBOL = "invalid_token_symbol";
  private String invalidTokenSymbol;

  public InvalidTokenSymbolErrorAllOf() { 
  }

  public InvalidTokenSymbolErrorAllOf invalidTokenSymbol(String invalidTokenSymbol) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The token symbol which was invalid. A descriptive reason is given in the main error message.")
  ...
  public boolean equals(Object o) {
    ...
    InvalidTokenSymbolErrorAllOf invalidTokenSymbolErrorAllOf = (InvalidTokenSymbolErrorAllOf) o;
    return Objects.equals(this.invalidTokenSymbol, invalidTokenSymbolErrorAllOf.invalidTokenSymbol);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidTokenSymbol);
  }
