 ...
 */
@JsonPropertyOrder({
  TransactionsSinceHashBatchResponse.JSON_PROPERTY_LEDGER_STATE,
  TransactionsSinceHashBatchResponse.JSON_PROPERTY_ACCOUNT_TRANSACTIONS,
  TransactionsSinceHashBatchResponse.JSON_PROPERTY_HAS_MORE
})
@JsonTypeName("TransactionsSinceHashBatchResponse")
...
public class TransactionsSinceHashBatchResponse {
  ...
  public TransactionsSinceHashBatchResponse() { 
  }

  public TransactionsSinceHashBatchResponse ledgerState(LedgerState ledgerState) {
  ...
  **/
  ...
  public TransactionsSinceHashBatchResponse accountTransactions(List<AccountTransactionInfo> accountTransactions) {
    
    this.accountTransactions = accountTransactions;
    return this;
  }

  public TransactionsSinceHashBatchResponse addAccountTransactionsItem(AccountTransactionInfo accountTransactionsItem) {
    this.accountTransactions.add(accountTransactionsItem);
    return this;
  }

   /**
   * The oldest transactions that match the criteria.
   * @return accountTransactions
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The oldest transactions that match the criteria.")
  ...
  public TransactionsSinceHashBatchResponse hasMore(Boolean hasMore) {
   ...
   /**
   * true if there are more transactions at the current state version for given accounts
   * @return hasMore
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "true if there are more transactions at the current state version for given accounts")
  ...
  public boolean equals(Object o) {
    ...
    TransactionsSinceHashBatchResponse transactionsSinceHashBatchResponse = (TransactionsSinceHashBatchResponse) o;
    return Objects.equals(this.ledgerState, transactionsSinceHashBatchResponse.ledgerState) &&
        Objects.equals(this.accountTransactions, transactionsSinceHashBatchResponse.accountTransactions) &&
        Objects.equals(this.hasMore, transactionsSinceHashBatchResponse.hasMore);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ledgerState, accountTransactions, hasMore);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TransactionsSinceHashBatchResponse {\n");
