...
import live.radix.gateway.model.AccountTransactionPair;
 ...
 */
@JsonPropertyOrder({
  TransactionsSinceHashBatchRequest.JSON_PROPERTY_NETWORK_IDENTIFIER,
  TransactionsSinceHashBatchRequest.JSON_PROPERTY_SINCE_ACCOUNT_TRANSACTIONS,
  TransactionsSinceHashBatchRequest.JSON_PROPERTY_LIMIT
})
...
public class TransactionsSinceHashBatchRequest {
  ...
  public TransactionsSinceHashBatchRequest() { 
  }
  ...
  **/
  ...
  public TransactionsSinceHashBatchRequest sinceAccountTransactions(List<AccountTransactionPair> sinceAccountTransactions) {
    
    this.sinceAccountTransactions = sinceAccountTransactions;
    return this;
  }

  public TransactionsSinceHashBatchRequest addSinceAccountTransactionsItem(AccountTransactionPair sinceAccountTransactionsItem) {
    this.sinceAccountTransactions.add(sinceAccountTransactionsItem);
    return this;
  }

   /**
   * A list of up to 100 pairs: [ account, last seen transaction identifier(optional) ].
   * @return sinceAccountTransactions
  **/
  @javax.annotation.Nonnull
  ...
  @JsonProperty(JSON_PROPERTY_SINCE_ACCOUNT_TRANSACTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSinceAccountTransactions(List<AccountTransactionPair> sinceAccountTransactions) {
    this.sinceAccountTransactions = sinceAccountTransactions;
  }


  public TransactionsSinceHashBatchRequest limit(Integer limit) {
   ...
   /**
   * The number of transactions to return. The maximum value is 100. Default - 30.
   * @return limit
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of transactions to return. The maximum value is 100. Default - 30.")
  ...
  public boolean equals(Object o) {
    ...
    TransactionsSinceHashBatchRequest transactionsSinceHashBatchRequest = (TransactionsSinceHashBatchRequest) o;
    return Objects.equals(this.networkIdentifier, transactionsSinceHashBatchRequest.networkIdentifier) &&
        Objects.equals(this.sinceAccountTransactions, transactionsSinceHashBatchRequest.sinceAccountTransactions) &&
        Objects.equals(this.limit, transactionsSinceHashBatchRequest.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(networkIdentifier, sinceAccountTransactions, limit);
  }
  ...
  public String toString() {
    ...
    sb.append("    sinceAccountTransactions: ").append(toIndentedString(sinceAccountTransactions)).append("\n");
