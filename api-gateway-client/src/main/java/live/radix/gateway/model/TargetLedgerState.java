...
@JsonTypeName("TargetLedgerState")
...
public class TargetLedgerState {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The latest-seen state version of the tip of the network's ledger. If this is singificantly ahead of the current LedgerState version, the Network Gateway is possibly behind and may be reporting outdated information. ")
