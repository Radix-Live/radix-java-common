 ...
 */
@JsonPropertyOrder({
  InvalidAccountAddressErrorAllOf.JSON_PROPERTY_INVALID_ACCOUNT_ADDRESS
})
@JsonTypeName("InvalidAccountAddressError_allOf")
...
public class InvalidAccountAddressErrorAllOf {
  ...
  public InvalidAccountAddressErrorAllOf() { 
  }

  public InvalidAccountAddressErrorAllOf invalidAccountAddress(String invalidAccountAddress) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The account address which was invalid. A descriptive reason is given in the main error message.")
  ...
  public boolean equals(Object o) {
    ...
    InvalidAccountAddressErrorAllOf invalidAccountAddressErrorAllOf = (InvalidAccountAddressErrorAllOf) o;
    return Objects.equals(this.invalidAccountAddress, invalidAccountAddressErrorAllOf.invalidAccountAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidAccountAddress);
  }
