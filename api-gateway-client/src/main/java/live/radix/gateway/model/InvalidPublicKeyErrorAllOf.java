 ...
 */
@JsonPropertyOrder({
  InvalidPublicKeyErrorAllOf.JSON_PROPERTY_INVALID_PUBLIC_KEY
})
@JsonTypeName("InvalidPublicKeyError_allOf")
...
public class InvalidPublicKeyErrorAllOf {
  public static final String JSON_PROPERTY_INVALID_PUBLIC_KEY = "invalid_public_key";
  private String invalidPublicKey;

  public InvalidPublicKeyErrorAllOf() { 
  }

  public InvalidPublicKeyErrorAllOf invalidPublicKey(String invalidPublicKey) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_INVALID_PUBLIC_KEY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvalidPublicKey(String invalidPublicKey) {
    this.invalidPublicKey = invalidPublicKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    InvalidPublicKeyErrorAllOf invalidPublicKeyErrorAllOf = (InvalidPublicKeyErrorAllOf) o;
    return Objects.equals(this.invalidPublicKey, invalidPublicKeyErrorAllOf.invalidPublicKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidPublicKey);
  }
