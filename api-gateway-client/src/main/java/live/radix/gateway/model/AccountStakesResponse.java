...
@JsonPropertyOrder({
  ...
  AccountStakesResponse.JSON_PROPERTY_PENDING_STAKES,
  AccountStakesResponse.JSON_PROPERTY_STAKES
})
@JsonTypeName("AccountStakesResponse")
...
public class AccountStakesResponse {
  ...
  public static final String JSON_PROPERTY_PENDING_STAKES = "pending_stakes";
  private List<AccountStakeEntry> pendingStakes = new ArrayList<>();

  public static final String JSON_PROPERTY_STAKES = "stakes";
  private List<AccountStakeEntry> stakes = new ArrayList<>();

  public AccountStakesResponse() { 
  }
  ...
  **/
  ...
  public AccountStakesResponse pendingStakes(List<AccountStakeEntry> pendingStakes) {
    
    this.pendingStakes = pendingStakes;
    return this;
  }

  public AccountStakesResponse addPendingStakesItem(AccountStakeEntry pendingStakesItem) {
    this.pendingStakes.add(pendingStakesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The stake positions which will become staked at the next epoch change.")
  @JsonProperty(JSON_PROPERTY_PENDING_STAKES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<AccountStakeEntry> getPendingStakes() {
    return pendingStakes;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PENDING_STAKES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPendingStakes(List<AccountStakeEntry> pendingStakes) {
    this.pendingStakes = pendingStakes;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The stake positions which are currently staked.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ledgerState, accountStakesResponse.ledgerState) &&
        Objects.equals(this.pendingStakes, accountStakesResponse.pendingStakes) &&
        Objects.equals(this.stakes, accountStakesResponse.stakes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ledgerState, pendingStakes, stakes);
  }
  ...
  public String toString() {
    ...
    sb.append("    pendingStakes: ").append(toIndentedString(pendingStakes)).append("\n");
