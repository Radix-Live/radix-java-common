 ...
 */
@JsonPropertyOrder({
  InvalidTokenRRIErrorAllOf.JSON_PROPERTY_INVALID_RRI
})
@JsonTypeName("InvalidTokenRRIError_allOf")
...
public class InvalidTokenRRIErrorAllOf {
  public static final String JSON_PROPERTY_INVALID_RRI = "invalid_rri";
  private String invalidRri;

  public InvalidTokenRRIErrorAllOf() { 
  }

  public InvalidTokenRRIErrorAllOf invalidRri(String invalidRri) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The token rri which was invalid. A descriptive reason is given in the main error message.")
  ...
  public boolean equals(Object o) {
    ...
    InvalidTokenRRIErrorAllOf invalidTokenRRIErrorAllOf = (InvalidTokenRRIErrorAllOf) o;
    return Objects.equals(this.invalidRri, invalidTokenRRIErrorAllOf.invalidRri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidRri);
  }
