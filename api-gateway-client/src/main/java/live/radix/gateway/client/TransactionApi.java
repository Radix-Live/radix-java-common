...
public class TransactionApi {
   ...
   * @param recentTransactionsRequest  (required)
  ...
  public RecentTransactionsResponse transactionRecentPost(RecentTransactionsRequest recentTransactionsRequest) throws ApiException {
    Object localVarPostBody = recentTransactionsRequest;
    ...
    // create path and map variables
    String localVarPath = "/transaction/recent";
    ...
    TypeReference<RecentTransactionsResponse> localVarReturnType = new TypeReference<RecentTransactionsResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "POST",
        localVarQueryParams,
