...
public class BatchTransactionsApi {
   ...
   * @param transactionsSinceHashBatchRequest  (required)
   * @return TransactionsSinceHashBatchResponse
  ...
  public TransactionsSinceHashBatchResponse customTransactionsBatchSinceAccountTransactionsPost(TransactionsSinceHashBatchRequest transactionsSinceHashBatchRequest) throws ApiException {
    Object localVarPostBody = transactionsSinceHashBatchRequest;
    
    // verify the required parameter 'transactionsSinceHashBatchRequest' is set
    ...
    String localVarPath = "/custom/transactions-batch/since-account-transactions";
    ...
    TypeReference<TransactionsSinceHashBatchResponse> localVarReturnType = new TypeReference<TransactionsSinceHashBatchResponse>() {};
   ...
   * @param transactionsSinceStateBatchRequest  (required)
   * @return TransactionsSinceStateBatchResponse
   * @throws ApiException if fails to make API call
   */
  public TransactionsSinceStateBatchResponse customTransactionsBatchSinceLedgerStatePost(TransactionsSinceStateBatchRequest transactionsSinceStateBatchRequest) throws ApiException {
    Object localVarPostBody = transactionsSinceStateBatchRequest;
    
    // verify the required parameter 'transactionsSinceStateBatchRequest' is set
    ...
    // create path and map variables
    String localVarPath = "/custom/transactions-batch/since-ledger-state";
    ...
    TypeReference<TransactionsSinceStateBatchResponse> localVarReturnType = new TypeReference<TransactionsSinceStateBatchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "POST",
        localVarQueryParams,
