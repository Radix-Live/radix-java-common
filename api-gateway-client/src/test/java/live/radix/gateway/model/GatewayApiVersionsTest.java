...
/**
 * Model tests for GatewayApiVersions
 */
public class GatewayApiVersionsTest {
    private final GatewayApiVersions model = new GatewayApiVersions();
