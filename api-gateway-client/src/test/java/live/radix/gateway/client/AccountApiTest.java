...
public class AccountApiTest {
     ...
     */
    @Test
    public void accountDerivePostTest() throws ApiException {
        AccountDeriveRequest accountDeriveRequest = null;
        AccountDeriveResponse response = api.accountDerivePost(accountDeriveRequest);
