...
public class TransactionApi extends BaseApi {
  ...
  public TransactionPreviewV2Response transactionPreviewV2Post(TransactionPreviewV2Request transactionPreviewV2Request) throws ApiException {
    return this.transactionPreviewV2Post(transactionPreviewV2Request, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public TransactionPreviewV2Response transactionPreviewV2Post(TransactionPreviewV2Request transactionPreviewV2Request, Map<String, String> additionalHeaders) throws ApiException {
