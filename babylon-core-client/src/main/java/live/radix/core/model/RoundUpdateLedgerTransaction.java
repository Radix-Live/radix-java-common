...
public class RoundUpdateLedgerTransaction extends LedgerTransaction {
  ...
  **/
  ...
  @Override
  public RoundUpdateLedgerTransaction type(LedgerTransactionType type) {
    this.setType(type);
    return this;
  }

  @Override
  public RoundUpdateLedgerTransaction payloadHex(String payloadHex) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `round_update_transaction` to the URL query string
    if (getRoundUpdateTransaction() != null) {
      joiner.add(getRoundUpdateTransaction().toUrlQueryString(prefix + "round_update_transaction" + suffix));
    }
