...
import live.radix.core.model.LedgerHeader;
...
public class LedgerProof {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `ledger_header` to the URL query string
    if (getLedgerHeader() != null) {
      joiner.add(getLedgerHeader().toUrlQueryString(prefix + "ledger_header" + suffix));
    }
