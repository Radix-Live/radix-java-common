...
public class KeyValueStoreTypeInfoDetails extends TypeInfoDetails {
  ...
  **/
  ...
  @Override
  public KeyValueStoreTypeInfoDetails type(TypeInfoType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `key_value_store_info` to the URL query string
    if (getKeyValueStoreInfo() != null) {
      joiner.add(getKeyValueStoreInfo().toUrlQueryString(prefix + "key_value_store_info" + suffix));
    }
