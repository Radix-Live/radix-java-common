...
public class FungibleResourceManagerFieldTotalSupplySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public FungibleResourceManagerFieldTotalSupplySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public FungibleResourceManagerFieldTotalSupplySubstate isLocked(Boolean isLocked) {
