...
public class LtsTransactionSubmitIntentAlreadyCommitted extends LtsTransactionSubmitErrorDetails {
  ...
  **/
  ...
  @Override
  public LtsTransactionSubmitIntentAlreadyCommitted type(LtsTransactionSubmitErrorDetailsType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `committed_as` to the URL query string
    if (getCommittedAs() != null) {
      joiner.add(getCommittedAs().toUrlQueryString(prefix + "committed_as" + suffix));
    }
