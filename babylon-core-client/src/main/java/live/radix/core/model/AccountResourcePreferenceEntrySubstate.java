...
public class AccountResourcePreferenceEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public AccountResourcePreferenceEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public AccountResourcePreferenceEntrySubstate isLocked(Boolean isLocked) {
