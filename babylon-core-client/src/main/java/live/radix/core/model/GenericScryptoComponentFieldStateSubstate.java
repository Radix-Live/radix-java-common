...
public class GenericScryptoComponentFieldStateSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public GenericScryptoComponentFieldStateSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public GenericScryptoComponentFieldStateSubstate isLocked(Boolean isLocked) {
