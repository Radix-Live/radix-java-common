...
public class ValidatorFieldProtocolUpdateReadinessSignalSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public ValidatorFieldProtocolUpdateReadinessSignalSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public ValidatorFieldProtocolUpdateReadinessSignalSubstate isLocked(Boolean isLocked) {
