...
public class KeyValueStoreEntryStructure extends SubstateSystemStructure {
  ...
  @Override
  public KeyValueStoreEntryStructure type(SubstateSystemStructureType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `key_full_type_id` to the URL query string
    if (getKeyFullTypeId() != null) {
      joiner.add(getKeyFullTypeId().toUrlQueryString(prefix + "key_full_type_id" + suffix));
    }

    // add `value_full_type_id` to the URL query string
    if (getValueFullTypeId() != null) {
      joiner.add(getValueFullTypeId().toUrlQueryString(prefix + "value_full_type_id" + suffix));
    }
