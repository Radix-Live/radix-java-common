...
public class ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate isLocked(Boolean isLocked) {
