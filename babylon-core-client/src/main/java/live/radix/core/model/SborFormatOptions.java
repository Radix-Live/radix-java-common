...
public class SborFormatOptions {
  ...
  **/
  ...
  public Boolean isProgrammaticJson() {
    return programmaticJson;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (isProgrammaticJson() != null) {
      try {
        joiner.add(String.format("%sprogrammatic_json%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isProgrammaticJson()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
