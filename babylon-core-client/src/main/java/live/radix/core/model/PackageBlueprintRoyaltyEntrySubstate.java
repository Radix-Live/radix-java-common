...
public class PackageBlueprintRoyaltyEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public PackageBlueprintRoyaltyEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public PackageBlueprintRoyaltyEntrySubstate isLocked(Boolean isLocked) {
