...
public class StateValidatorResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `protocol_update_readiness_signal` to the URL query string
    if (getProtocolUpdateReadinessSignal() != null) {
      joiner.add(getProtocolUpdateReadinessSignal().toUrlQueryString(prefix + "protocol_update_readiness_signal" + suffix));
    }
