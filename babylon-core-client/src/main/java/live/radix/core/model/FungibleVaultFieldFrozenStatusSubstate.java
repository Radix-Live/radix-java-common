...
public class FungibleVaultFieldFrozenStatusSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public FungibleVaultFieldFrozenStatusSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public FungibleVaultFieldFrozenStatusSubstate isLocked(Boolean isLocked) {
