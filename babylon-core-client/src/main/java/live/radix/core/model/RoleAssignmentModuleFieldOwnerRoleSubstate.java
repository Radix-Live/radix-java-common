...
public class RoleAssignmentModuleFieldOwnerRoleSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public RoleAssignmentModuleFieldOwnerRoleSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public RoleAssignmentModuleFieldOwnerRoleSubstate isLocked(Boolean isLocked) {
