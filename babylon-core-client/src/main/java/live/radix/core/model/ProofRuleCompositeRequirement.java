...
public class ProofRuleCompositeRequirement extends CompositeRequirement {
  ...
  @Override
  public ProofRuleCompositeRequirement type(CompositeRequirementType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `proof_rule` to the URL query string
    if (getProofRule() != null) {
      joiner.add(getProofRule().toUrlQueryString(prefix + "proof_rule" + suffix));
    }
