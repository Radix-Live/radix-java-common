...
import live.radix.core.model.OwnerRoleUpdater;
...
public class OwnerRole {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `updater` to the URL query string
    if (getUpdater() != null) {
      try {
        joiner.add(String.format("%supdater%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUpdater()), "UTF-8").replaceAll("\\+", "%20")));
