...
public class ConsensusManagerFieldCurrentValidatorSetSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public ConsensusManagerFieldCurrentValidatorSetSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public ConsensusManagerFieldCurrentValidatorSetSubstate isLocked(Boolean isLocked) {
