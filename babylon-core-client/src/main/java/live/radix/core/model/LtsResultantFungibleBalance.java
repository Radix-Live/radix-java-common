...
public class LtsResultantFungibleBalance {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `resultant_balance` to the URL query string
    if (getResultantBalance() != null) {
      try {
        joiner.add(String.format("%sresultant_balance%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getResultantBalance()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
