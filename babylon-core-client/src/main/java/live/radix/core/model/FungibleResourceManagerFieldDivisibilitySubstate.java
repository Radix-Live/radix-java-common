...
public class FungibleResourceManagerFieldDivisibilitySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public FungibleResourceManagerFieldDivisibilitySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public FungibleResourceManagerFieldDivisibilitySubstate isLocked(Boolean isLocked) {
