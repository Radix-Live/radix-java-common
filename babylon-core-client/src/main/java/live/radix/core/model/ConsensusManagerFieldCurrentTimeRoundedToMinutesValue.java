...
public class ConsensusManagerFieldCurrentTimeRoundedToMinutesValue {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `proposer_timestamp_rounded_down_to_minute` to the URL query string
    if (getProposerTimestampRoundedDownToMinute() != null) {
      joiner.add(getProposerTimestampRoundedDownToMinute().toUrlQueryString(prefix + "proposer_timestamp_rounded_down_to_minute" + suffix));
    }
