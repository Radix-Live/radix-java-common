...
public class BootLoaderModuleFieldSystemBootValue {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `system_version` to the URL query string
    if (getSystemVersion() != null) {
      try {
        joiner.add(String.format("%ssystem_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSystemVersion()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    // add `system_parameters` to the URL query string
    if (getSystemParameters() != null) {
      joiner.add(getSystemParameters().toUrlQueryString(prefix + "system_parameters" + suffix));
    }
