...
public class ConsensusManagerFieldCurrentTimeSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public ConsensusManagerFieldCurrentTimeSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public ConsensusManagerFieldCurrentTimeSubstate isLocked(Boolean isLocked) {
