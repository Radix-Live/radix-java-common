...
public class NonFungibleResourceManagerFieldIdTypeSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public NonFungibleResourceManagerFieldIdTypeSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public NonFungibleResourceManagerFieldIdTypeSubstate isLocked(Boolean isLocked) {
