...
public class LedgerHeaderSummary {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `epoch_round` to the URL query string
    if (getEpochRound() != null) {
      joiner.add(getEpochRound().toUrlQueryString(prefix + "epoch_round" + suffix));
    }

    // add `ledger_hashes` to the URL query string
    if (getLedgerHashes() != null) {
      joiner.add(getLedgerHashes().toUrlQueryString(prefix + "ledger_hashes" + suffix));
    }
