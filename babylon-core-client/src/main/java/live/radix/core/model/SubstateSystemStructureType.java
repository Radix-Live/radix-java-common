...
public enum SubstateSystemStructureType {
  ...
  KEY_VALUE_STORE_ENTRY("KeyValueStoreEntry"),
  
  OBJECT_FIELD("ObjectField"),
  
  OBJECT_KEY_VALUE_PARTITION_ENTRY("ObjectKeyValuePartitionEntry"),
  
  OBJECT_INDEX_PARTITION_ENTRY("ObjectIndexPartitionEntry"),
  
  OBJECT_SORTED_INDEX_PARTITION_ENTRY("ObjectSortedIndexPartitionEntry");
