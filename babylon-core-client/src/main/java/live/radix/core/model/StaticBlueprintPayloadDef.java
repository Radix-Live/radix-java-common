...
public class StaticBlueprintPayloadDef extends BlueprintPayloadDef {
  ...
  **/
  ...
  @Override
  public StaticBlueprintPayloadDef type(BlueprintPayloadDefType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `type_id` to the URL query string
    if (getTypeId() != null) {
      joiner.add(getTypeId().toUrlQueryString(prefix + "type_id" + suffix));
    }
