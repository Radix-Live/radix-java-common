...
public class PackageFieldRoyaltyAccumulatorSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public PackageFieldRoyaltyAccumulatorSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public PackageFieldRoyaltyAccumulatorSubstate isLocked(Boolean isLocked) {
