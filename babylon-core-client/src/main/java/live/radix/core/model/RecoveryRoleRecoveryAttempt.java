...
public class RecoveryRoleRecoveryAttempt {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `timed_recovery_allowed_after` to the URL query string
    if (getTimedRecoveryAllowedAfter() != null) {
      joiner.add(getTimedRecoveryAllowedAfter().toUrlQueryString(prefix + "timed_recovery_allowed_after" + suffix));
    }
