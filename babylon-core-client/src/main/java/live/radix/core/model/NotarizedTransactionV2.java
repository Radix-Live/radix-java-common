...
public class NotarizedTransactionV2 {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `signed_transaction_intent` to the URL query string
    if (getSignedTransactionIntent() != null) {
      joiner.add(getSignedTransactionIntent().toUrlQueryString(prefix + "signed_transaction_intent" + suffix));
    }
