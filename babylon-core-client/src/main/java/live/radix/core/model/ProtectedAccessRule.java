...
public class ProtectedAccessRule extends AccessRule {
  ...
  @Override
  public ProtectedAccessRule type(AccessRuleType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `access_rule` to the URL query string
    if (getAccessRule() != null) {
      joiner.add(getAccessRule().toUrlQueryString(prefix + "access_rule" + suffix));
    }
