...
public class PackageCodeOriginalCodeEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public PackageCodeOriginalCodeEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public PackageCodeOriginalCodeEntrySubstate isLocked(Boolean isLocked) {
