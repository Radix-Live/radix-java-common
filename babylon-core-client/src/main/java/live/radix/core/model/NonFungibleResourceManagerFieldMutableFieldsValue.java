...
public class NonFungibleResourceManagerFieldMutableFieldsValue {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMutableFields() != null) {
      for (int i = 0; i < getMutableFields().size(); i++) {
        if (getMutableFields().get(i) != null) {
          joiner.add(getMutableFields().get(i).toUrlQueryString(String.format("%smutable_fields%s%s", prefix, suffix,
