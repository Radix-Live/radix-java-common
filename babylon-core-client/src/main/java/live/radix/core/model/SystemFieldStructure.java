...
public class SystemFieldStructure extends SubstateSystemStructure {
  ...
  **/
  ...
  @Override
  public SystemFieldStructure type(SubstateSystemStructureType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `field_kind` to the URL query string
    if (getFieldKind() != null) {
      try {
        joiner.add(String.format("%sfield_kind%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFieldKind()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
