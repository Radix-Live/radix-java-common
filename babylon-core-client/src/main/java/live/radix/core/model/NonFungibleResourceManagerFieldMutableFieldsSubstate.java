...
public class NonFungibleResourceManagerFieldMutableFieldsSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public NonFungibleResourceManagerFieldMutableFieldsSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public NonFungibleResourceManagerFieldMutableFieldsSubstate isLocked(Boolean isLocked) {
