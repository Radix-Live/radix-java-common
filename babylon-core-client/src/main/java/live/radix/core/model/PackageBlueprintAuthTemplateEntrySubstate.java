...
public class PackageBlueprintAuthTemplateEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public PackageBlueprintAuthTemplateEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public PackageBlueprintAuthTemplateEntrySubstate isLocked(Boolean isLocked) {
