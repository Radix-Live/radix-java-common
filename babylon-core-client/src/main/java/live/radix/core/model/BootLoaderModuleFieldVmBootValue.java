...
public class BootLoaderModuleFieldVmBootValue {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `scrypto_v1_minor_version` to the URL query string
    if (getScryptoV1MinorVersion() != null) {
      try {
        joiner.add(String.format("%sscrypto_v1_minor_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getScryptoV1MinorVersion()), "UTF-8").replaceAll("\\+", "%20")));
