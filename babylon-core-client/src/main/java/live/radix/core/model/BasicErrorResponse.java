...
public class BasicErrorResponse extends ErrorResponse {
  ...
  @Override
  public BasicErrorResponse errorType(ErrorResponseType errorType) {
    this.setErrorType(errorType);
    return this;
  }

  @Override
  public BasicErrorResponse code(Integer code) {
    this.setCode(code);
    return this;
  }
  ...
  @Override
  public BasicErrorResponse traceId(String traceId) {
