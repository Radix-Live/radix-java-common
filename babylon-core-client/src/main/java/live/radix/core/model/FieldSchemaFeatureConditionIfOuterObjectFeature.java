...
public class FieldSchemaFeatureConditionIfOuterObjectFeature extends FieldSchemaFeatureCondition {
  ...
  @Override
  public FieldSchemaFeatureConditionIfOuterObjectFeature type(FieldSchemaFeatureConditionType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFeatureName() != null) {
      try {
        joiner.add(String.format("%sfeature_name%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFeatureName()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
