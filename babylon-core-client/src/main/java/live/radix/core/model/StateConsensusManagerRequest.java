...
public class StateConsensusManagerRequest {
  ...
  public Boolean isIncludeReadinessSignals() {
    return includeReadinessSignals;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `include_readiness_signals` to the URL query string
    if (isIncludeReadinessSignals() != null) {
      try {
        joiner.add(String.format("%sinclude_readiness_signals%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isIncludeReadinessSignals()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
