...
public class RoleAssignmentModuleRuleEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public RoleAssignmentModuleRuleEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public RoleAssignmentModuleRuleEntrySubstate isLocked(Boolean isLocked) {
