...
public class BlueprintSchemaCollectionPartition {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `partition_description` to the URL query string
    if (getPartitionDescription() != null) {
      joiner.add(getPartitionDescription().toUrlQueryString(prefix + "partition_description" + suffix));
    }

    // add `collection_schema` to the URL query string
    if (getCollectionSchema() != null) {
      joiner.add(getCollectionSchema().toUrlQueryString(prefix + "collection_schema" + suffix));
    }
