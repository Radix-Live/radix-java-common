...
public class PackageBlueprintDependenciesEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public PackageBlueprintDependenciesEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public PackageBlueprintDependenciesEntrySubstate isLocked(Boolean isLocked) {
