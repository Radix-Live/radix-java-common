...
public class NonFungibleVaultContentsIndexEntryValue {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `is_present` to the URL query string
    if (isIsPresent() != null) {
      try {
        joiner.add(String.format("%sis_present%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isIsPresent()), "UTF-8").replaceAll("\\+", "%20")));
