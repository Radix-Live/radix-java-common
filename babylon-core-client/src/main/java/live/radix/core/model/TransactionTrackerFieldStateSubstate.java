...
public class TransactionTrackerFieldStateSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public TransactionTrackerFieldStateSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public TransactionTrackerFieldStateSubstate isLocked(Boolean isLocked) {
