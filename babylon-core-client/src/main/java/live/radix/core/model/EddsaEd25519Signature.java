...
public class EddsaEd25519Signature extends Signature {
  ...
  @Override
  public EddsaEd25519Signature keyType(PublicKeyType keyType) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `signature_hex` to the URL query string
    if (getSignatureHex() != null) {
      try {
        joiner.add(String.format("%ssignature_hex%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSignatureHex()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
