...
public class TransactionTrackerCollectionEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public TransactionTrackerCollectionEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public TransactionTrackerCollectionEntrySubstate isLocked(Boolean isLocked) {
