...
public class LtsTransactionSubmitRejectedErrorDetails extends LtsTransactionSubmitErrorDetails {
  ...
  **/
  ...
  public LtsTransactionSubmitRejectedErrorDetails retryFromTimestamp(Instant retryFromTimestamp) {
  ...
  **/
  ...
  @Override
  public LtsTransactionSubmitRejectedErrorDetails type(LtsTransactionSubmitErrorDetailsType type) {
    this.setType(type);
    return this;
  }
