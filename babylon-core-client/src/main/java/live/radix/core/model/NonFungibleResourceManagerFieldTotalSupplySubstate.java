...
public class NonFungibleResourceManagerFieldTotalSupplySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public NonFungibleResourceManagerFieldTotalSupplySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public NonFungibleResourceManagerFieldTotalSupplySubstate isLocked(Boolean isLocked) {
