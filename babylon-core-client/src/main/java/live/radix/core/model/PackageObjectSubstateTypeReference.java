...
public class PackageObjectSubstateTypeReference extends ObjectSubstateTypeReference {
  ...
  @Override
  public PackageObjectSubstateTypeReference type(ObjectSubstateTypeReferenceType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `full_type_id` to the URL query string
    if (getFullTypeId() != null) {
      joiner.add(getFullTypeId().toUrlQueryString(prefix + "full_type_id" + suffix));
    }
