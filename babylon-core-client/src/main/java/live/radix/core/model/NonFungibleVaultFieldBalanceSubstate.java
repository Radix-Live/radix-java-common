...
public class NonFungibleVaultFieldBalanceSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public NonFungibleVaultFieldBalanceSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public NonFungibleVaultFieldBalanceSubstate isLocked(Boolean isLocked) {
