...
public class ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate isLocked(Boolean isLocked) {
