...
@JsonTypeName("ParsedNotarizedTransaction_allOf_validation_error")
...
public class ParsedNotarizedTransactionAllOfValidationError {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `is_permanent` to the URL query string
    if (isIsPermanent() != null) {
      try {
        joiner.add(String.format("%sis_permanent%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isIsPermanent()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
