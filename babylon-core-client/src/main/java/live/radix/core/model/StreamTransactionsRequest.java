...
public class StreamTransactionsRequest {
  ...
  public Boolean isIncludeProofs() {
    return includeProofs;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `include_proofs` to the URL query string
    if (isIncludeProofs() != null) {
      try {
        joiner.add(String.format("%sinclude_proofs%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isIncludeProofs()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
