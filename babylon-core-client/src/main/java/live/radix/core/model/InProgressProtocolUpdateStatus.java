...
public class InProgressProtocolUpdateStatus extends ProtocolUpdateStatus {
  ...
  @Override
  public InProgressProtocolUpdateStatus type(ProtocolUpdateStatusType type) {
    this.setType(type);
    return this;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `latest_commit` to the URL query string
    if (getLatestCommit() != null) {
      joiner.add(getLatestCommit().toUrlQueryString(prefix + "latest_commit" + suffix));
    }
