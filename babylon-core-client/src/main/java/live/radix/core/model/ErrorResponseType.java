...
public enum ErrorResponseType {
  ...
  LTS_TRANSACTION_SUBMIT("LtsTransactionSubmit"),
  
  TRANSACTION_PREVIEW_V2("TransactionPreviewV2"),
  
  STREAM_TRANSACTIONS("StreamTransactions"),
  
  STREAM_PROOFS("StreamProofs");
