...
public class ProtocolUpdateStatusModuleFieldSummarySubstate extends Substate {
  ...
  @Override
  public ProtocolUpdateStatusModuleFieldSummarySubstate isLocked(Boolean isLocked) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getProtocolVersion() != null) {
      try {
        joiner.add(String.format("%sprotocol_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getProtocolVersion()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUpdateStatus() != null) {
      joiner.add(getUpdateStatus().toUrlQueryString(prefix + "update_status" + suffix));
    }
