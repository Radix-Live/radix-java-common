...
public enum TransactionIntentStatus {
  ...
  COMMITTED_SUCCESS("CommittedSuccess"),
  
  COMMITTED_FAILURE("CommittedFailure"),
  
  PERMANENT_REJECTION("PermanentRejection"),
  
  IN_MEMPOOL("InMempool"),
  
  NOT_SEEN("NotSeen"),
  
  FATE_UNCERTAIN("FateUncertain"),
  
  FATE_UNCERTAIN_BUT_LIKELY_REJECTION("FateUncertainButLikelyRejection");
