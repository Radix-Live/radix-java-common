...
public class ConsensusManagerFieldValidatorRewardsSubstate extends Substate {
  ...
  **/
  ...
  @Override
  public ConsensusManagerFieldValidatorRewardsSubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public ConsensusManagerFieldValidatorRewardsSubstate isLocked(Boolean isLocked) {
