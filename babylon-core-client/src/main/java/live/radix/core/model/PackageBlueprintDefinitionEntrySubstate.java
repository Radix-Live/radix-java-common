...
public class PackageBlueprintDefinitionEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public PackageBlueprintDefinitionEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public PackageBlueprintDefinitionEntrySubstate isLocked(Boolean isLocked) {
