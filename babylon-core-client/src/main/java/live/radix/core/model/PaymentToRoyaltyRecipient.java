...
public class PaymentToRoyaltyRecipient {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `royalty_recipient` to the URL query string
    if (getRoyaltyRecipient() != null) {
      joiner.add(getRoyaltyRecipient().toUrlQueryString(prefix + "royalty_recipient" + suffix));
    }
