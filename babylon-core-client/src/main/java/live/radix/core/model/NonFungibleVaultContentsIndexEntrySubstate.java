...
public class NonFungibleVaultContentsIndexEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public NonFungibleVaultContentsIndexEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public NonFungibleVaultContentsIndexEntrySubstate isLocked(Boolean isLocked) {
