...
public class FlashLedgerTransaction extends LedgerTransaction {
  ...
  @Override
  public FlashLedgerTransaction type(LedgerTransactionType type) {
    this.setType(type);
    return this;
  }

  @Override
  public FlashLedgerTransaction payloadHex(String payloadHex) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `flashed_state_updates` to the URL query string
    if (getFlashedStateUpdates() != null) {
      joiner.add(getFlashedStateUpdates().toUrlQueryString(prefix + "flashed_state_updates" + suffix));
    }
