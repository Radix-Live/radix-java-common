...
public class RoyaltyModuleMethodRoyaltyEntrySubstate extends Substate {
  ...
  **/
  ...
  @Override
  public RoyaltyModuleMethodRoyaltyEntrySubstate substateType(SubstateType substateType) {
    this.setSubstateType(substateType);
    return this;
  }

  @Override
  public RoyaltyModuleMethodRoyaltyEntrySubstate isLocked(Boolean isLocked) {
