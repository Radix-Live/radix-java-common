...
public class LocalNonFungibleKey {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `non_fungible_local_id` to the URL query string
    if (getNonFungibleLocalId() != null) {
      joiner.add(getNonFungibleLocalId().toUrlQueryString(prefix + "non_fungible_local_id" + suffix));
    }
