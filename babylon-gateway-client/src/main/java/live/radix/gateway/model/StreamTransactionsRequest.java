...
public class StreamTransactionsRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(atLedgerState), hashCodeNullable(cursor), hashCodeNullable(limitPerPage), hashCodeNullable(fromLedgerState), kindFilter, manifestAccountsWithdrawnFromFilter, manifestAccountsDepositedIntoFilter, manifestResourcesFilter, affectedGlobalEntitiesFilter, eventsFilter, order, optIns);
  }
