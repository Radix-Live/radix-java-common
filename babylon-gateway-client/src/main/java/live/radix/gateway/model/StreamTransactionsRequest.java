...
public class StreamTransactionsRequest {
  ...
  private List<String> eventGlobalEmittersFilter = new ArrayList<>();
  ...
  public StreamTransactionsRequest eventGlobalEmittersFilter(List<String> eventGlobalEmittersFilter) {
  ...
  public List<String> getEventGlobalEmittersFilter() {
    return eventGlobalEmittersFilter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EVENT_GLOBAL_EMITTERS_FILTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEventGlobalEmittersFilter(List<String> eventGlobalEmittersFilter) {
    this.eventGlobalEmittersFilter = eventGlobalEmittersFilter;
  }
