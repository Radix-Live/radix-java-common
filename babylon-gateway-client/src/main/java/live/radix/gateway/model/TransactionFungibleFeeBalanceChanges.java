...
import live.radix.gateway.model.TransactionFungibleFeeBalanceChangeType;
 ...
 */
@JsonPropertyOrder({
  TransactionFungibleFeeBalanceChanges.JSON_PROPERTY_TYPE,
  TransactionFungibleFeeBalanceChanges.JSON_PROPERTY_ENTITY_ADDRESS,
  TransactionFungibleFeeBalanceChanges.JSON_PROPERTY_RESOURCE_ADDRESS,
  TransactionFungibleFeeBalanceChanges.JSON_PROPERTY_BALANCE_CHANGE
})
...
public class TransactionFungibleFeeBalanceChanges {
  public static final String JSON_PROPERTY_TYPE = "type";
  private TransactionFungibleFeeBalanceChangeType type;
  ...
  public TransactionFungibleFeeBalanceChanges() {
  }

  public TransactionFungibleFeeBalanceChanges type(TransactionFungibleFeeBalanceChangeType type) {
  ...
  public TransactionFungibleFeeBalanceChangeType getType() {
    return type;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setType(TransactionFungibleFeeBalanceChangeType type) {
    this.type = type;
  }

  public TransactionFungibleFeeBalanceChanges entityAddress(String entityAddress) {
  ...
  public TransactionFungibleFeeBalanceChanges resourceAddress(String resourceAddress) {
  ...
  public TransactionFungibleFeeBalanceChanges balanceChange(String balanceChange) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionFungibleFeeBalanceChanges transactionFungibleFeeBalanceChanges = (TransactionFungibleFeeBalanceChanges) o;
    return Objects.equals(this.type, transactionFungibleFeeBalanceChanges.type) &&
        Objects.equals(this.entityAddress, transactionFungibleFeeBalanceChanges.entityAddress) &&
        Objects.equals(this.resourceAddress, transactionFungibleFeeBalanceChanges.resourceAddress) &&
        Objects.equals(this.balanceChange, transactionFungibleFeeBalanceChanges.balanceChange);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, entityAddress, resourceAddress, balanceChange);
  }
