...
import live.radix.gateway.model.StateKeyValueStoreKeysResponseItem;
 ...
 */
@JsonPropertyOrder({
  StateKeyValueStoreKeysResponse.JSON_PROPERTY_LEDGER_STATE,
  StateKeyValueStoreKeysResponse.JSON_PROPERTY_TOTAL_COUNT,
  StateKeyValueStoreKeysResponse.JSON_PROPERTY_NEXT_CURSOR,
  StateKeyValueStoreKeysResponse.JSON_PROPERTY_ITEMS,
  StateKeyValueStoreKeysResponse.JSON_PROPERTY_KEY_VALUE_STORE_ADDRESS
})
...
public class StateKeyValueStoreKeysResponse {
  ...
  private List<StateKeyValueStoreKeysResponseItem> items = new ArrayList<>();
  ...
  public StateKeyValueStoreKeysResponse() {
  }

  public StateKeyValueStoreKeysResponse ledgerState(LedgerState ledgerState) {
  ...
  public StateKeyValueStoreKeysResponse totalCount(Long totalCount) {
  ...
  public StateKeyValueStoreKeysResponse nextCursor(String nextCursor) {
  ...
  public StateKeyValueStoreKeysResponse items(List<StateKeyValueStoreKeysResponseItem> items) {
    
    this.items = items;
    return this;
  }

  public StateKeyValueStoreKeysResponse addItemsItem(StateKeyValueStoreKeysResponseItem itemsItem) {
    if (this.items == null) {
  ...
  public List<StateKeyValueStoreKeysResponseItem> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(List<StateKeyValueStoreKeysResponseItem> items) {
    this.items = items;
  }

  public StateKeyValueStoreKeysResponse keyValueStoreAddress(String keyValueStoreAddress) {
  ...
  public boolean equals(Object o) {
    ...
    StateKeyValueStoreKeysResponse stateKeyValueStoreKeysResponse = (StateKeyValueStoreKeysResponse) o;
    return Objects.equals(this.ledgerState, stateKeyValueStoreKeysResponse.ledgerState) &&
        equalsNullable(this.totalCount, stateKeyValueStoreKeysResponse.totalCount) &&
        equalsNullable(this.nextCursor, stateKeyValueStoreKeysResponse.nextCursor) &&
        Objects.equals(this.items, stateKeyValueStoreKeysResponse.items) &&
        Objects.equals(this.keyValueStoreAddress, stateKeyValueStoreKeysResponse.keyValueStoreAddress);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ledgerState, hashCodeNullable(totalCount), hashCodeNullable(nextCursor), items, keyValueStoreAddress);
  }
