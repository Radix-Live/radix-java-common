...
public enum TransactionFungibleFeeBalanceChangeType {
  ...
  FEE_DISTRIBUTED("FeeDistributed"),
  
  TIP_DISTRIBUTED("TipDistributed"),
  
  ROYALTY_DISTRIBUTED("RoyaltyDistributed");

  private String value;

  TransactionFungibleFeeBalanceChangeType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static TransactionFungibleFeeBalanceChangeType fromValue(String value) {
    for (TransactionFungibleFeeBalanceChangeType b : TransactionFungibleFeeBalanceChangeType.values()) {
