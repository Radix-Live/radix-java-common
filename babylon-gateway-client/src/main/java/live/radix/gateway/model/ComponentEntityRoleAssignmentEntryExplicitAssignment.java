 ...
 */
@JsonPropertyOrder({
  ComponentEntityRoleAssignmentEntryExplicitAssignment.JSON_PROPERTY_EXPLICIT_RULE
})
...
@JsonIgnoreProperties(
  value = "resolution", // ignore manually set resolution, it will be automatically generated by Jackson during serialization
  allowSetters = true // allows the resolution to be set during deserialization
)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "resolution", visible = true)

public class ComponentEntityRoleAssignmentEntryExplicitAssignment extends ComponentEntityRoleAssignmentEntryAssignment {
  public static final String JSON_PROPERTY_EXPLICIT_RULE = "explicit_rule";
  private Object explicitRule;

  public ComponentEntityRoleAssignmentEntryExplicitAssignment() {

  }

  public ComponentEntityRoleAssignmentEntryExplicitAssignment explicitRule(Object explicitRule) {
  ...
  @Override
  public ComponentEntityRoleAssignmentEntryExplicitAssignment resolution(RoleAssignmentResolution resolution) {
  ...
  public boolean equals(Object o) {
    ...
    ComponentEntityRoleAssignmentEntryExplicitAssignment componentEntityRoleAssignmentEntryExplicitAssignment = (ComponentEntityRoleAssignmentEntryExplicitAssignment) o;
    return Objects.equals(this.explicitRule, componentEntityRoleAssignmentEntryExplicitAssignment.explicitRule) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(explicitRule, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ComponentEntityRoleAssignmentEntryExplicitAssignment {\n");
