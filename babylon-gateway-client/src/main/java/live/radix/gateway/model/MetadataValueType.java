...
public enum MetadataValueType {
  ...
  GLOBAL_ADDRESS_ARRAY("GlobalAddressArray"),
  
  PUBLIC_KEY_ARRAY("PublicKeyArray"),
  
  NON_FUNGIBLE_GLOBAL_ID_ARRAY("NonFungibleGlobalIdArray"),
  
  NON_FUNGIBLE_LOCAL_ID_ARRAY("NonFungibleLocalIdArray"),
  
  INSTANT_ARRAY("InstantArray"),
  
  URL_ARRAY("UrlArray"),
  
  ORIGIN_ARRAY("OriginArray"),
  
  PUBLIC_KEY_HASH_ARRAY("PublicKeyHashArray");
