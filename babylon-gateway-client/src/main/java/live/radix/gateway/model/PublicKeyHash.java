 ...
 */
@JsonPropertyOrder({
  PublicKeyHash.JSON_PROPERTY_KEY_HASH_TYPE
})
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = PublicKeyHashEcdsaSecp256k1.class, name = "EcdsaSecp256k1"),
  @JsonSubTypes.Type(value = PublicKeyHashEddsaEd25519.class, name = "EddsaEd25519"),
})

public class PublicKeyHash {
  public static final String JSON_PROPERTY_KEY_HASH_TYPE = "key_hash_type";
  protected PublicKeyHashType keyHashType;

  public PublicKeyHash() {
  }

  public PublicKeyHash keyHashType(PublicKeyHashType keyHashType) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_KEY_HASH_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public PublicKeyHashType getKeyHashType() {
    return keyHashType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_KEY_HASH_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setKeyHashType(PublicKeyHashType keyHashType) {
    this.keyHashType = keyHashType;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyHashType, publicKeyHash.keyHashType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyHashType);
  }
  ...
  public String toString() {
    ...
    sb.append("    keyHashType: ").append(toIndentedString(keyHashType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
