...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ComponentEntityRoleAssignmentEntryExplicitAssignment.class, name = "Explicit"),
  @JsonSubTypes.Type(value = ComponentEntityRoleAssignmentEntryOwnerAssignment.class, name = "Owner"),
})

public class ComponentEntityRoleAssignmentEntryAssignment {
  public static final String JSON_PROPERTY_RESOLUTION = "resolution";
  protected RoleAssignmentResolution resolution;
