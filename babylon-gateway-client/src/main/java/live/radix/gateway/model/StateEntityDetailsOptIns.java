...
@JsonPropertyOrder({
  ...
  StateEntityDetailsOptIns.JSON_PROPERTY_DAPP_TWO_WAY_LINKS,
  StateEntityDetailsOptIns.JSON_PROPERTY_NATIVE_RESOURCE_DETAILS
})
...
public class StateEntityDetailsOptIns {
  ...
  public static final String JSON_PROPERTY_DAPP_TWO_WAY_LINKS = "dapp_two_way_links";
  private Boolean dappTwoWayLinks = false;

  public static final String JSON_PROPERTY_NATIVE_RESOURCE_DETAILS = "native_resource_details";
  private Boolean nativeResourceDetails = false;
  ...
  public StateEntityDetailsOptIns dappTwoWayLinks(Boolean dappTwoWayLinks) {
   ...
   * @return dappTwoWayLinks
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DAPP_TWO_WAY_LINKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean isDappTwoWayLinks() {
    return dappTwoWayLinks;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DAPP_TWO_WAY_LINKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDappTwoWayLinks(Boolean dappTwoWayLinks) {
    this.dappTwoWayLinks = dappTwoWayLinks;
  }

  public StateEntityDetailsOptIns nativeResourceDetails(Boolean nativeResourceDetails) {
  ...
  public Boolean isNativeResourceDetails() {
    return nativeResourceDetails;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NATIVE_RESOURCE_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNativeResourceDetails(Boolean nativeResourceDetails) {
    this.nativeResourceDetails = nativeResourceDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ancestorIdentities, stateEntityDetailsOptIns.ancestorIdentities) &&
        ...
        Objects.equals(this.dappTwoWayLinks, stateEntityDetailsOptIns.dappTwoWayLinks) &&
        Objects.equals(this.nativeResourceDetails, stateEntityDetailsOptIns.nativeResourceDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ancestorIdentities, componentRoyaltyConfig, componentRoyaltyVaultBalance, packageRoyaltyVaultBalance, nonFungibleIncludeNfids, explicitMetadata, dappTwoWayLinks, nativeResourceDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("    dappTwoWayLinks: ").append(toIndentedString(dappTwoWayLinks)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `dapp_two_way_links` to the URL query string
    if (isDappTwoWayLinks() != null) {
      try {
        joiner.add(String.format("%sdapp_two_way_links%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isDappTwoWayLinks()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (isNativeResourceDetails() != null) {
      try {
        joiner.add(String.format("%snative_resource_details%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isNativeResourceDetails()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
