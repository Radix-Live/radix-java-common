...
public enum SubintentStatus {
  ...
  @JsonCreator
  public static SubintentStatus fromValue(String value) {
    for (SubintentStatus b : SubintentStatus.values()) {
