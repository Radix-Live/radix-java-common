 ...
 */
@JsonPropertyOrder({
  ProgrammaticScryptoSborValueBool.JSON_PROPERTY_VALUE
})
...
public class ProgrammaticScryptoSborValueBool extends ProgrammaticScryptoSborValue {
  public static final String JSON_PROPERTY_VALUE = "value";
  private Boolean value;

  public ProgrammaticScryptoSborValueBool() {

  }

  public ProgrammaticScryptoSborValueBool value(Boolean value) {
  ...
  @Override
  public ProgrammaticScryptoSborValueBool kind(ProgrammaticScryptoSborValueKind kind) {
    this.setKind(kind);
    return this;
  }

  @Override
  public ProgrammaticScryptoSborValueBool typeName(String typeName) {
    this.setTypeName(typeName);
    return this;
  }

  @Override
  public ProgrammaticScryptoSborValueBool fieldName(String fieldName) {
  ...
  public boolean equals(Object o) {
    ...
    ProgrammaticScryptoSborValueBool programmaticScryptoSborValueBool = (ProgrammaticScryptoSborValueBool) o;
    return Objects.equals(this.value, programmaticScryptoSborValueBool.value) &&
        super.equals(o);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (isValue() != null) {
      try {
        joiner.add(String.format("%svalue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(isValue()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
