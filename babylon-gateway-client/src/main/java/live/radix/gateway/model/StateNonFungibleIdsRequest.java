...
public class StateNonFungibleIdsRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.atLedgerState, stateNonFungibleIdsRequest.atLedgerState) &&
        equalsNullable(this.cursor, stateNonFungibleIdsRequest.cursor) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(atLedgerState), hashCodeNullable(cursor), hashCodeNullable(limitPerPage), resourceAddress);
  }
