...
public enum ManifestClass {
  ...
  POOL_REDEMPTION("PoolRedemption"),
  
  VALIDATOR_STAKE("ValidatorStake"),
  
  VALIDATOR_UNSTAKE("ValidatorUnstake"),
  
  VALIDATOR_CLAIM("ValidatorClaim"),
  
  ACCOUNT_DEPOSIT_SETTINGS_UPDATE("AccountDepositSettingsUpdate");

  private String value;

  ManifestClass(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ManifestClass fromValue(String value) {
    for (ManifestClass b : ManifestClass.values()) {
