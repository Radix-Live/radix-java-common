...
public class CommittedTransactionInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stateVersion, epoch, round, roundTimestamp, transactionStatus, payloadHash, intentHash, feePaid, affectedGlobalEntities, hashCodeNullable(confirmedAt), hashCodeNullable(errorMessage), rawHex, receipt, message, hashCodeNullable(balanceChanges));
  }
