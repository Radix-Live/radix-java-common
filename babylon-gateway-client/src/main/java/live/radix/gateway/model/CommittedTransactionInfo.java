...
public class CommittedTransactionInfo {
  ...
  private JsonNullable<TransactionBalanceChanges> balanceChanges = JsonNullable.<TransactionBalanceChanges>undefined();
  ...
  public CommittedTransactionInfo balanceChanges(TransactionBalanceChanges balanceChanges) {
    this.balanceChanges = JsonNullable.<TransactionBalanceChanges>of(balanceChanges);
  ...
  public TransactionBalanceChanges getBalanceChanges() {
        return balanceChanges.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_BALANCE_CHANGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<TransactionBalanceChanges> getBalanceChanges_JsonNullable() {
    return balanceChanges;
  }
  
  @JsonProperty(JSON_PROPERTY_BALANCE_CHANGES)
  public void setBalanceChanges_JsonNullable(JsonNullable<TransactionBalanceChanges> balanceChanges) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.stateVersion, committedTransactionInfo.stateVersion) &&
        ...
        equalsNullable(this.balanceChanges, committedTransactionInfo.balanceChanges) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stateVersion, epoch, round, roundTimestamp, transactionStatus, payloadHash, intentHash, feePaid, affectedGlobalEntities, hashCodeNullable(confirmedAt), hashCodeNullable(errorMessage), rawHex, receipt, manifestInstructions, manifestClasses, message, hashCodeNullable(balanceChanges), subintentDetails, childSubintentHashes);
  }
