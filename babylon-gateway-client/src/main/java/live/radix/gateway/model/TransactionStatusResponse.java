...
public class TransactionStatusResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ledgerState, status, intentStatus, intentStatusDescription, knownPayloads, hashCodeNullable(committedStateVersion), hashCodeNullable(errorMessage));
  }
