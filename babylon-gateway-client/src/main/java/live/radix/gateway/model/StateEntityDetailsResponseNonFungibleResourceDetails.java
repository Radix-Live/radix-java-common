...
@JsonPropertyOrder({
  ...
  StateEntityDetailsResponseNonFungibleResourceDetails.JSON_PROPERTY_NON_FUNGIBLE_DATA_MUTABLE_FIELDS,
  StateEntityDetailsResponseNonFungibleResourceDetails.JSON_PROPERTY_TWO_WAY_LINKED_DAPPS,
  StateEntityDetailsResponseNonFungibleResourceDetails.JSON_PROPERTY_NATIVE_RESOURCE_DETAILS
})
...
public class StateEntityDetailsResponseNonFungibleResourceDetails extends StateEntityDetailsResponseItemDetails {
  ...
  public StateEntityDetailsResponseNonFungibleResourceDetails nonFungibleDataMutableFields(List<String> nonFungibleDataMutableFields) {
    
    this.nonFungibleDataMutableFields = nonFungibleDataMutableFields;
    return this;
  }

  public StateEntityDetailsResponseNonFungibleResourceDetails addNonFungibleDataMutableFieldsItem(String nonFungibleDataMutableFieldsItem) {
    if (this.nonFungibleDataMutableFields == null) {
      this.nonFungibleDataMutableFields = new ArrayList<>();
    }
  ...
  /**
   * Get nonFungibleDataMutableFields
  ...
  public StateEntityDetailsResponseNonFungibleResourceDetails twoWayLinkedDapps(TwoWayLinkedDappsCollection twoWayLinkedDapps) {
  ...
  public StateEntityDetailsResponseNonFungibleResourceDetails nativeResourceDetails(NativeResourceDetails nativeResourceDetails) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.roleAssignments, stateEntityDetailsResponseNonFungibleResourceDetails.roleAssignments) &&
        ...
        Objects.equals(this.nonFungibleDataMutableFields, stateEntityDetailsResponseNonFungibleResourceDetails.nonFungibleDataMutableFields) &&
        Objects.equals(this.twoWayLinkedDapps, stateEntityDetailsResponseNonFungibleResourceDetails.twoWayLinkedDapps) &&
        Objects.equals(this.nativeResourceDetails, stateEntityDetailsResponseNonFungibleResourceDetails.nativeResourceDetails) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(roleAssignments, nonFungibleIdType, totalSupply, totalMinted, totalBurned, nonFungibleDataMutableFields, twoWayLinkedDapps, nativeResourceDetails, super.hashCode());
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `non_fungible_data_mutable_fields` to the URL query string
    if (getNonFungibleDataMutableFields() != null) {
      for (int i = 0; i < getNonFungibleDataMutableFields().size(); i++) {
        try {
          joiner.add(String.format("%snon_fungible_data_mutable_fields%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
              URLEncoder.encode(String.valueOf(getNonFungibleDataMutableFields().get(i)), "UTF-8").replaceAll("\\+", "%20")));
        } catch (UnsupportedEncodingException e) {
          // Should never happen, UTF-8 is always supported
          throw new RuntimeException(e);
        }
