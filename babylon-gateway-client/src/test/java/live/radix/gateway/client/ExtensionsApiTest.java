...
public class ExtensionsApiTest {
     ...
     */
    @Test
    public void resourceHoldersPageTest() throws ApiException {
        ResourceHoldersRequest resourceHoldersRequest = null;
        ResourceHoldersResponse response = api.resourceHoldersPage(resourceHoldersRequest);
